...
namespace Ultravox
{
    public partial class AccountsClient
    {
        ...
        {
            var __response = await AccountsMeBillingUsageRetrieveAsResponseAsync(
                fromDate: fromDate,
                toDate: toDate,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ultravox.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ultravox.AutoSDKHttpResponse<global::Ultravox.UsageResponse>> AccountsMeBillingUsageRetrieveAsResponseAsync(
            global::System.DateTime? fromDate = default,
            global::System.DateTime? toDate = default,
            global::Ultravox.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ultravox.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ultravox.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AccountsMeBillingUsageRetrieve",
                                methodName: "AccountsMeBillingUsageRetrieveAsync",
                                pathTemplate: "\"/api/accounts/me/billing/usage\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Ultravox.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ultravox.UsageResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ultravox.AutoSDKHttpResponse<global::Ultravox.UsageResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ultravox.UsageResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
