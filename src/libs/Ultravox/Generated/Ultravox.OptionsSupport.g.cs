...
namespace Ultravox
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Ultravox.AutoSDKRetryOptions Retry { get; set; } = new global::Ultravox.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Ultravox.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Ultravox.IAutoSDKHook>();
        ...
        public global::Ultravox.AutoSDKClientOptions AddHook(
            global::Ultravox.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Ultravox.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Ultravox.AutoSDKClientOptions UseAuthorizationProvider(
            global::Ultravox.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Ultravox.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Ultravox.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Ultravox.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Ultravox.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Ultravox.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Ultravox.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Ultravox.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Ultravox.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Ultravox.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Ultravox.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Ultravox.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Ultravox.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Ultravox.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Ultravox.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Ultravox.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Ultravox.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Ultravox.AutoSDKClientOptions clientOptions,
            global::Ultravox.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Ultravox.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Ultravox.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Ultravox.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Ultravox.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Ultravox.IAutoSDKHook, global::Ultravox.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Ultravox.AutoSDKHookContext context)
        {
