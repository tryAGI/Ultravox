...
namespace Ultravox
{
    public partial class SipClient
    {
        ...
        private static readonly global::Ultravox.EndPointSecurityRequirement s_SipPartialUpdateSecurityRequirement0 =
        ...
        private static readonly global::Ultravox.EndPointSecurityRequirement[] s_SipPartialUpdateSecurityRequirements =
            new global::Ultravox.EndPointSecurityRequirement[]
            {                s_SipPartialUpdateSecurityRequirement0,
            };
        partial void PrepareSipPartialUpdateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Ultravox.PatchedSipConfig request);
        partial void PrepareSipPartialUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Ultravox.PatchedSipConfig request);
        partial void ProcessSipPartialUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task<global::Ultravox.SipConfig> SipPartialUpdateAsync(

            global::Ultravox.PatchedSipConfig request,
            global::Ultravox.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await SipPartialUpdateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ultravox.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ultravox.AutoSDKHttpResponse<global::Ultravox.SipConfig>> SipPartialUpdateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSipPartialUpdateArguments(
            ...
            var __authorizations = global::Ultravox.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SipPartialUpdateSecurityRequirements,
                operationName: "SipPartialUpdateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSipPartialUpdateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ultravox.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ultravox.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SipPartialUpdate",
                                methodName: "SipPartialUpdateAsync",
                                pathTemplate: "\"/api/sip\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSipPartialUpdateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ultravox.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSipPartialUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ultravox.SipConfig.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ultravox.AutoSDKHttpResponse<global::Ultravox.SipConfig>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ultravox.SipConfig.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Ultravox.SipConfig> SipPartialUpdateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ultravox.PatchedSipConfig
            {
                AllowedCidrRanges = allowedCidrRanges,
                AllowAllAgents = allowAllAgents,
                AllowedAgents = allowedAgents,
            };

            return await SipPartialUpdateAsync(
                request: __request,
                requestOptions: requestOptions,
