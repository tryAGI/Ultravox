...
namespace Ultravox
{
    public partial class CallsClient
    {
        ...
        private static readonly global::Ultravox.EndPointSecurityRequirement s_SendDataMessageToCallSecurityRequirement0 =
        ...
        private static readonly global::Ultravox.EndPointSecurityRequirement[] s_SendDataMessageToCallSecurityRequirements =
            new global::Ultravox.EndPointSecurityRequirement[]
            {                s_SendDataMessageToCallSecurityRequirement0,
            };
        partial void PrepareSendDataMessageToCallArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid callId,
            global::Ultravox.SendCallDataMessage request);
        partial void PrepareSendDataMessageToCallRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid callId,
            global::Ultravox.SendCallDataMessage request);
        partial void ProcessSendDataMessageToCallResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task SendDataMessageToCallAsync(
            global::System.Guid callId,
        ...
        {
            await SendDataMessageToCallAsResponseAsync(
                callId: callId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ultravox.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ultravox.AutoSDKHttpResponse> SendDataMessageToCallAsResponseAsync(
            global::System.Guid callId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSendDataMessageToCallArguments(
            ...
            var __authorizations = global::Ultravox.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SendDataMessageToCallSecurityRequirements,
                operationName: "SendDataMessageToCallAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Ultravox.PathBuilder(
                                path: $"/api/calls/{callId}/send_data_message",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ultravox.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ultravox.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SendDataMessageToCall",
                                methodName: "SendDataMessageToCallAsync",
                                pathTemplate: "$\"/api/calls/{callId}/send_data_message\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSendDataMessageToCallResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task SendDataMessageToCallAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ultravox.SendCallDataMessage
            {
                Type = type,
            };

            await SendDataMessageToCallAsync(
                callId: callId,
                request: __request,
                requestOptions: requestOptions,
