...
namespace Ultravox
{
    public partial class SipClient
    {
        ...
        private static readonly global::Ultravox.EndPointSecurityRequirement s_SipRegistrationsPartialUpdateSecurityRequirement0 =
        ...
        private static readonly global::Ultravox.EndPointSecurityRequirement[] s_SipRegistrationsPartialUpdateSecurityRequirements =
            new global::Ultravox.EndPointSecurityRequirement[]
            {                s_SipRegistrationsPartialUpdateSecurityRequirement0,
            };
        ...
        {
            var __response = await SipRegistrationsPartialUpdateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ultravox.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ultravox.AutoSDKHttpResponse<global::Ultravox.SipRegistration>> SipRegistrationsPartialUpdateAsResponseAsync(
            string registrationId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Ultravox.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SipRegistrationsPartialUpdateSecurityRequirements,
                operationName: "SipRegistrationsPartialUpdateAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ultravox.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ultravox.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SipRegistrationsPartialUpdate",
                                methodName: "SipRegistrationsPartialUpdateAsync",
                                pathTemplate: "$\"/api/sip/registrations/{registrationId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Ultravox.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ultravox.SipRegistration.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ultravox.AutoSDKHttpResponse<global::Ultravox.SipRegistration>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ultravox.SipRegistration.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
