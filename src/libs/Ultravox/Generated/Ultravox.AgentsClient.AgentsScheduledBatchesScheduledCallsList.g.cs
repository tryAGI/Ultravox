...
namespace Ultravox
{
    public partial class AgentsClient
    {
        ...
        {
            var __response = await AgentsScheduledBatchesScheduledCallsListAsResponseAsync(
                agentId: agentId,
                batchId: batchId,
                cursor: cursor,
                pageSize: pageSize,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ultravox.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ultravox.AutoSDKHttpResponse<global::Ultravox.PaginatedScheduledCallList>> AgentsScheduledBatchesScheduledCallsListAsResponseAsync(
            global::System.Guid agentId,
            global::System.Guid batchId,
            string? cursor = default,
            int? pageSize = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ultravox.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ultravox.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AgentsScheduledBatchesScheduledCallsList",
                                methodName: "AgentsScheduledBatchesScheduledCallsListAsync",
                                pathTemplate: "$\"/api/agents/{agentId}/scheduled_batches/{batchId}/scheduled_calls\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Ultravox.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ultravox.PaginatedScheduledCallList.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ultravox.AutoSDKHttpResponse<global::Ultravox.PaginatedScheduledCallList>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ultravox.PaginatedScheduledCallList.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
