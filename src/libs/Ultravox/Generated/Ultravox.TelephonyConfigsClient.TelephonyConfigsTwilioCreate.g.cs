...
namespace Ultravox
{
    public partial class TelephonyConfigsClient
    {
        ...
        private static readonly global::Ultravox.EndPointSecurityRequirement s_TelephonyConfigsTwilioCreateSecurityRequirement0 =
        ...
        private static readonly global::Ultravox.EndPointSecurityRequirement[] s_TelephonyConfigsTwilioCreateSecurityRequirements =
            new global::Ultravox.EndPointSecurityRequirement[]
            {                s_TelephonyConfigsTwilioCreateSecurityRequirement0,
            };
        partial void PrepareTelephonyConfigsTwilioCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Ultravox.TwilioConfig request);
        partial void PrepareTelephonyConfigsTwilioCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Ultravox.TwilioConfig request);
        partial void ProcessTelephonyConfigsTwilioCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTelephonyConfigsTwilioCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Ultravox.TwilioConfig> TelephonyConfigsTwilioCreateAsync(

            global::Ultravox.TwilioConfig request,
            global::Ultravox.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await TelephonyConfigsTwilioCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ultravox.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ultravox.AutoSDKHttpResponse<global::Ultravox.TwilioConfig>> TelephonyConfigsTwilioCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareTelephonyConfigsTwilioCreateArguments(
            ...
            var __authorizations = global::Ultravox.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TelephonyConfigsTwilioCreateSecurityRequirements,
                operationName: "TelephonyConfigsTwilioCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareTelephonyConfigsTwilioCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ultravox.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ultravox.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TelephonyConfigsTwilioCreate",
                                methodName: "TelephonyConfigsTwilioCreateAsync",
                                pathTemplate: "\"/api/telephony_configs/twilio\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTelephonyConfigsTwilioCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ultravox.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTelephonyConfigsTwilioCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ultravox.TwilioConfig.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ultravox.AutoSDKHttpResponse<global::Ultravox.TwilioConfig>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ultravox.TwilioConfig.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Ultravox.TwilioConfig> TelephonyConfigsTwilioCreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ultravox.TwilioConfig
            {
            ...
            return await TelephonyConfigsTwilioCreateAsync(
                request: __request,
                requestOptions: requestOptions,
